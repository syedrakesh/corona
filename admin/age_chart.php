...
<html>  
<head>  
<title>বয়স ভিত্তিক পরিসংখ্যান হালনাগাদ - আ্যাডমিন প্যানেল</title>
			...
			<div class="col-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading text-center">
						<p>বয়স ভিত্তিক পরিসংখ্যান হালনাগাদ - আ্যাডমিন প্যানেল</p>
					</div>
					<div class="panel-body">
						<form role="form" method="post"><?php while($row = $q->fetch()){ ?>
							<div class="form-group">
								<label for="age">বয়স সীমাঃ</label>
								<input type="text" class="form-control" name="age" id="age" value="<?php echo htmlspecialchars($row['age']);?>" readonly>
							</div>
							<div class="form-group">
								<label for="patient_number<?php echo htmlspecialchars($row['id']);?>">রোগীর সংখ্যাঃ</label>
								<input type="text" class="form-control" name="patient_number<?php echo htmlspecialchars($row['id']);?>" id="patient_number<?php echo htmlspecialchars($row['id']);?>" value="<?php echo htmlspecialchars($row['patient']);?>">
							</div>
							<?php } ?>   
...
<?php
		if(isset($_POST['update'])){
			...
			$patient_number2 = $_POST['patient_number2'];
			...
			$query2 = "UPDATE $table_name SET patient='$patient_number1' where id=1";
			$q = $pdo->query($query2);
			
			$query3 = "UPDATE $table_name SET patient='$patient_number2' where id=2";
			$q = $pdo->query($query3);
